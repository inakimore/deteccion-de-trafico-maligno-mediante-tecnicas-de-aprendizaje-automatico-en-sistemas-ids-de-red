# Eje E - El inter-arribo como vista, y su robustez ante evasion (Friday-02-03-2018)
...
|-------|--------------------------|-------------------------|-------|
| payload (byte-CNN) | 1.0000 | 0.0025 | **0.9975** |
| meta+rafaga | 0.9983 | 0.9983 | **0.0000** |
| inter-arribo SOLO | 0.9900 | 0.9900 | **0.0000** |
| meta+inter-arribo | 0.9933 | 0.9933 | **0.0000** |
