# Eje E - El inter-arribo como vista, y su robustez ante evasion (Tuesday-20-02-2018)
...
|-------|--------------------------|-------------------------|-------|
| payload (byte-CNN) | 1.0000 | 0.0108 | **0.9892** |
| meta+rafaga | 0.9992 | 0.9992 | **0.0000** |
| inter-arribo SOLO | 0.9467 | 0.9467 | **0.0000** |
| meta+inter-arribo | 1.0000 | 1.0000 | **0.0000** |
