# Eje E - El inter-arribo como vista, y su robustez ante evasion (Thursday-22-02-2018)

Binario Attack vs Benign en servicio=http (DPI), balanceado 1:1, split 70/30. El atacante camufla los primeros **24 bytes** de cada flujo de ataque con los de un cliente benigno; el resto del flujo no cambia.

| Vista | Recall ataque (original) | Recall ataque (evadido) | Caida |
|-------|--------------------------|-------------------------|-------|
| payload (byte-CNN) | 0.9672 | 0.8852 | **0.0820** |
| meta+rafaga | 1.0000 | 1.0000 | **0.0000** |
| inter-arribo SOLO | 0.8525 | 0.8525 | **0.0000** |
| meta+inter-arribo | 0.9508 | 0.9508 | **0.0000** |
